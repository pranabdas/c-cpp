...
<picture>
  <source type="image/webp" srcSet={require("/img/tree-rotation.webp").default} />
  <img src={require("/img/tree-rotation.png").default} alt="tree-rotation" />
</picture>
